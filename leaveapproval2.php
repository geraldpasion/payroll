	...
	<head>
		...
		$(document).ready(function(){
			 showEdited=function(){
				...
				history.replaceState({}, "Title", "leaveapproval2.php");
			}
		...
		<div class="modal-dialog modal-small">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class='btn btn-primary' type='submit' id="approved2" name = "approved2"><i class='fa fa-check'></i> Approve</button></a>
					<button class='btn btn-danger' type='submit' name = "disapproved2"><i class='fa fa-warning'></i> Disapprove</button></button></a>
