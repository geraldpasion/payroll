...
<html>
	<head>
		...
		$(document).ready(function(){
			...
			history.replaceState({}, "Title", "adminleaveapplication2.php");				
		});
		$(document).ready(function(){
			disable=function(){
				 toastr.options = { 
					...
					<?php
						...
						<form id = 'myForm1' method='POST' class='form-horizontal'>
							<div class='form-group'>
								...
								<div class='col-md-4'><input type='hidden' name='ss' onblur='this.form.submit()' id = 'idsss' value='".$eid."' class='form-control ename'></div>
						...
						<form id = 'myForm' method='POST' action = 'leaveapplicationexe.php' class='form-horizontal'>
							...
							<div class='form-group'>
								<div class='col-md-3'></div>
								<div class='col-md-5'><button id = 'submit' name = 'adleavesub2' type='submit' class='btn btn3 btn-w-m btn-primary'>Submit</button></div>
						...
						<form id = 'myForm' method='POST' action = 'leaveapplicationexe.php' class='form-horizontal'>
							...
							<div class='col-md-3'></div>
								<label class='col-sm-1 control-label'>Date</label>
								<div class='col-md-4'> <input id = 'date' type='text' onfocus='clearThis(this)' disabled class='form-control' name='daterange1' required='' onKeyPress='return noneonly(this, event)'/> </div>
							</div>
							<div class='form-group'>
							<div class='col-md-3'></div>
								<label class='col-sm-1 control-label'>Date</label>
								<div class='col-md-4'> <input id = 'date1' type='text' onfocus='clearThis(this)'  disabled class='form-control' name='daterange2' onKeyPress='return noneonly(this, event)'/> </div>
							
							</div>
							<div class='form-group'>
							<div class='col-md-3'></div>
								<label class='col-sm-1 control-label'>Date</label>
								<div class='col-md-4'> <input id = 'date2' type='text' onfocus='clearThis(this)'  disabled class='form-control' name='daterange3' onKeyPress='return noneonly(this, event)'/> </div>
							
							</div>
							<div class='form-group'><div class='col-md-3'></div>
								<label class='col-sm-1 control-label'>Date</label>
								<div class='col-md-4'> <input id = 'date3' type='text' onfocus='clearThis(this)' disabled class='form-control' name='daterange4' onKeyPress='return noneonly(this, event)'/> </div>
							...
							<div class='form-group'>
								<div class='col-md-3'></div>
								<div class='col-md-5'><button id = 'submit'  disabled='true' type='submit' class='btn btn3 btn-w-m btn-primary'>Submit</button></div>
								<div class='col-md-4'><button type='button' onclick = 'myFunction()' class='btn btn2 btn-w-m btn-white'>Reset</button></div>
							</div>
						</form>";
							}
