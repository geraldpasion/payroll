                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane active">
								...
								<div class="col-md-3"></div>
									<a href="testpic.png" title="Image from Unsplash" data-gallery="">
											<?php 
											if ($result1 = $mysqli->query("SELECT * FROM employee WHERE employee_id = '$employee_id'")){
													while ($row22 = mysqli_fetch_object($result1))
													{
														echo "<img class='profilepic' src='images/".$row22->image."'>";}
													}
											else
												echo '<img class = "profilepic" src="img/user/default.png">';
											?>
										</a>
