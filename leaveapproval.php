            ...
            <div class="ibox-tools">
				...
				<div class="ibox-content">
					...
					<?php
						...
						if ($result = $mysqli->query("SELECT * FROM tbl_leave INNER JOIN employee ON employee.employee_id = tbl_leave.employee_id WHERE leave_status = 'Pending' ORDER BY leave_id")) //get records from db
						{
