          ...
          // echo"<script>alert($total_records);</script>";
			...
			echo'</div>
				...
				if($num<=1){
					...
					echo " <a class='pagi' id='nexts' href='images3.php?page=$next1'> < </a>";
				}
			...
			//echo "  <a class='pagi' href='images.php?page=$page4'> $page4 </a>";
				...
				if($num>=$total_pages-2){
					...
					for($count;$count<=$total_pages;$count++) {
						//$count=$count-$count+1;
	            	echo "  <a class='pagi' href='images3.php?page=$count'> $count </a>";
					...
					if($num>1){
						$num--;
						echo "  <a class='pagi' href='images3.php?page=$num'> $num </a>";
						$num++;
						$max=3;
					}
			...
			if($num1>=$total_pages){
				...
				echo " <a class='pagi' id=''  href='images3.php?page=$next'> > </a>";
			}
