...
<html>
    <head>
        ...
        <?php
                            ...
                            $result13 = $mysqli->query("SELECT COUNT(*) AS total FROM inquiry RIGHT JOIN employee ON employee.employee_id = inquiry.employee_id WHERE inquiry_status = 'Pending' AND (employee_team = '$team1' OR employee_team1 = '$team2' OR employee_team2 = '$team3' OR employee_team3 = '$team4') AND (employee_level = 1 OR employee_level = 2 OR employee_level = 3)")->fetch_array();
                            $result14 = $mysqli->query("SELECT COUNT(*) AS total FROM inquiry RIGHT JOIN employee ON employee.employee_id = inquiry.employee_id WHERE inquiry_status = 'answered' AND (employee_team = '$team1' OR employee_team1 = '$team2' OR employee_team2 = '$team3' OR employee_team3 = '$team4') AND (employee_level = 1 OR employee_level = 2 OR employee_level = 3)")->fetch_array();
