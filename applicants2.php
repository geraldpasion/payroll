...
.ui-autocomplete { z-index:2147483647; }
		...
		toastr.options = { 
			  ...
			  "hideMethod": "fadeOut" // 1.5s
				...
				history.replaceState({}, "Title", "applicants2.php");
		}
					...
					<input type="text" class="form-control input-sm m-b-xs" id="filter" placeholder="Search in table">
						...
						<div class="ibox-content" id = "tableHolderz">
							...
							$employeeidsession = $_SESSION['logsession'];
								...
								if ($result1 = $mysqli->query("SELECT * FROM emp_data INNER JOIN studenttest ON emp_data.id=studenttest.stdid WHERE emp_data.interviewer = '$employeeidsession' ORDER BY interview_date DESC")) //get records from db
								{
		...
		<div class="modal-dialog modal-small">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="ibox-content">
						<form id = "uploadForm" method="POST" action = "applicantstatus2.php"  class="form-horizontal">
