					...
					<div class="ibox-content">
						<form id = "myForm" method="POST" class="form-horizontal">
							...
							<div class="col-md-3"></div>
								...
								<div class="col-md-4"><input id = "trainer" type="text" onfocus="clearThis(this)" name = "trainer" required="" onpaste="return false" onDrop="return false" class="form-control skills2 ename"></div>
							...
							<div class="col-md-3"></div>
								...
								<div class="col-md-4"><input id = "trainee" type="text" onfocus="clearThis(this)" name = "trainee" onpaste="return false" onDrop="return false" class = "form-control skills ename2" required="" class="form-control"></div>
