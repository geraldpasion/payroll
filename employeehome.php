...
<html>
	<head>
		...
		<?php
							...
							$result = $mysqli->query("SELECT COUNT(leave_status) AS total FROM tbl_leave WHERE leave_status = 'Pending' AND employee_id = $employee_id")->fetch_array();
							$result2 = $mysqli->query("SELECT COUNT(leave_status) AS total FROM tbl_leave WHERE leave_status = 'Approved' AND employee_id = $employee_id")->fetch_array();
							$result3 = $mysqli->query("SELECT COUNT(leave_status) AS total FROM tbl_leave WHERE leave_status = 'Disapproved' AND employee_id = $employee_id")->fetch_array();
							$result4 = $mysqli->query("SELECT COUNT(overtime_status) AS total FROM overtime WHERE overtime_status = 'Pending' AND employee_id = $employee_id")->fetch_array();
							$result5 = $mysqli->query("SELECT COUNT(overtime_status) AS total FROM overtime WHERE overtime_status = 'Approved' AND employee_id = $employee_id")->fetch_array();
							$result6 = $mysqli->query("SELECT COUNT(overtime_status) AS total FROM overtime WHERE overtime_status = 'Disapproved' AND employee_id = $employee_id")->fetch_array();
							$result7 = $mysqli->query("SELECT COUNT(coaching_status) AS total FROM coaching WHERE coaching_status = 'Pending' AND employee_id = $employee_id")->fetch_array();
							$result8 = $mysqli->query("SELECT COUNT(coaching_status) AS total FROM coaching WHERE coaching_status = 'Completed' AND employee_id = $employee_id")->fetch_array();
							...
							$result13 = $mysqli->query("SELECT COUNT(inquiry_status) AS total FROM inquiry WHERE inquiry_status = 'Pending' AND employee_id = $employee_id")->fetch_array();
							$result14 = $mysqli->query("SELECT COUNT(inquiry_status) AS total FROM inquiry WHERE inquiry_status = 'answered' AND employee_id = $employee_id")->fetch_array();
			...
			<div class="col-lg-4">
                        ...
                        <div class="m-b-md">
                            ...
                            <h3 class="font-bold no-margins">
							 ...
							 <small><?PHP echo date("F d, Y",strtotime($result9['announcement_date'])) ?> </small><br>
