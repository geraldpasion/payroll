...
function TaxSemiMonthly($TaxCode, $NetTaxableIncome, $return_grosscheck=0, $return_fixedamount=0){
...
ob_end_clean();
  ...
  for($i=7; $i>0; $i--){
    ...
    if($NetTaxableIncome>=$TaxValues['Semi-monthly'][$TaxCode][$Level]['GrossCheck']){

      echo 'NetTaxableIncome: '.$NetTaxableIncome.'<br>';
      echo $Level.'<br>';
      $grosscheck = $TaxValues['Semi-monthly'][$TaxCode][$Level]['GrossCheck'];
      ...
      $FixedTaxAmount=$TaxValues['Semi-monthly'][$TaxCode][$Level]['FixedTaxAmount'];
      ...
      //get % Over
      $PercentOver = $TaxValues['Semi-monthly'][$TaxCode][$Level]['PercentOver'];
