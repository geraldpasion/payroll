...
<head>
	...
	<body>
			...
			<div class="col-sm-1">
				...
				<button onclick="window.location.href='commentprev2.php?id=<?php echo $_GET['id']; ?>'" class="fa fa-chevron-left <?php if ($minzzx == $id2){echo 'hidden';}else{echo '';} ?>" style="font-size:25px"></button>
				</div>
		
				<div class="col-md-6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<button onclick="window.location.href='commentnext2.php?id=<?php echo $_GET['id']; ?>'" class="fa fa-chevron-right <?php if ($idzz == $id2){echo 'hidden';}else{echo '';} ?>" style="font-size:25px"></button>
