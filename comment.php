...
<head>
	...
	<body>
						...
						<!--body modal-->
                    	 	...
                    	 	<!--close button-->
                     	<button type="button" onClick="parent.location='images.php'" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
