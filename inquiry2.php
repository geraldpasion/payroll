...
<html>
	...
	toastr.options = { 
			  ...
			  "hideMethod": "fadeOut" // 1.5s
				...
				history.replaceState({}, "Title", "inquiry2.php");
		}
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<?php
							...
							if ($result = $mysqli->query("SELECT * FROM inquiry INNER JOIN employee ON employee.employee_id = inquiry.employee_id WHERE employee_team = '$team' AND inquiry_status = 'Pending' AND (employee_level = 2 or employee_level = 1) ORDER BY inquiry_date DESC")) //get records from db
							{
								if ($result->num_rows > 0) //display records if any
								{
									...
									while ($row = mysqli_fetch_object($result))
									{
										...
										if ($row->employee_id == $empid ){echo "<button class='btn btn-info hidden' name = 'edit' type='button'><i class='fa fa-paste'></i> Answer</button></a>&nbsp;&nbsp;";}else{echo "<button class='btn btn-info' name = 'edit' type='button'><i class='fa fa-paste'></i> Answer</button></a>&nbsp;&nbsp;";}
										echo "</td>";
										echo "</tr>";
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="ibox-content">
							<form id = "myForm" method="POST" action = "answerinquiry2.php" class="form-horizontal">
