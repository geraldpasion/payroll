	...
	<head>
		...
		<script>		
			...
			function showEmp(id, datef, datet) {
			    ...
			    document.location.href = "getEmpDetails.php?from=1&id="+id+"&datef="+datef+"&datet="+datet;
			}
		</script>
					...
					<div class="ibox-content">	<br><br>
						<div class="form-group">
							...
							<form method="POST" action="attendance.php">
								<table>
									<tr>
										<td style="padding:10px;"><h4><label class="control-label" style="margin-top:5px;">Select Date Range</label></h4></td>
