				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<?php
							...
							if ($result = $mysqli->query("SELECT * FROM inquiry RIGHT JOIN employee ON employee.employee_id = inquiry.employee_id WHERE inquiry_status = 'answered' ORDER BY inquiry_date DESC")) //get records from db
							{
