					...
					<div class="ibox-content">
						...
						<?php
							include('dbconfig.php');
								...
								if ($result = $mysqli->query("SELECT * FROM coaching INNER JOIN employee ON employee.employee_id = coaching.employee_id WHERE coaching_status = 'Completed' AND (employee_team = '$team1' OR employee_team = '$team2' OR employee_team = '$team3' OR employee_team = '$team4') AND (employee_level = 1 OR employee_level = 2)")) //get records from db
								{
