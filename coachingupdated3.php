					...
					<div class="ibox-content">
						...
						<?php
							include('dbconfig.php');
								...
								if ($result = $mysqli->query("SELECT * FROM coaching INNER JOIN employee ON employee.employee_id = coaching.employee_id WHERE coaching_status = 'Completed' AND (employee_team = '$team1' OR employee_team1 = '$team2' OR employee_team2 = '$team3' OR employee_team3 = '$team4') AND (employee_level = 1 OR employee_level = 2)")) //get records from db
								{
									...
									echo "</tfoot>";
										...
										while ($row = mysqli_fetch_object($result))
										{
											...
											echo "<td>" . $row->coaching_trainee . "</td>";
											echo "<td>" . $row->coaching_subject . "</td>";
											echo "<td>" . $row->coaching_result . "</td>";
					...
					<div class="ibox-content">
						...
						<input id = "empidz" name = "id" type="hidden" class="form-control" readonly = "readonly">
							<div class="form-group">
								...
								<div class="col-md-8"><textarea type="text" class="form-control" id = "subject" name = "subject" placeholder="Input your coaching result here..."></textarea></div>
							</div>
