  ...
  <div class="panel-body">
    ...
    <body >
        ...
        ?>
            ...
            <form id="stdtest" action="stdtest.php?id=<?php echo $_GET['id'].'&'."stdname=".$_GET['id']."&testcode=".$_GET['testcode']; ?>" method="post">
                    ...
                    <?php
                            if (isset($_REQUEST['testcode'])) {
                                ...
                                echo "<div class=\"pmsg\" style=\"color:#a000000; text-align:center;\">Offered Tests</div>";
                            }
                    ?>
                    <?php
                    ...
                    ?>
                                <table cellpadding="30" cellspacing="10">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <input type="submit" tabindex="3" value="Start Test" name="starttest" class="btn btn-info"/>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <?php
                                ...
                                $result = executeQuery("SELECT * FROM test");
                                if (mysql_num_rows($result) == 0) {
                                    echo"<h3 style=\"color:#a000000;text-align:center;\">Sorry...! For this moment, You have not Offered to take any tests.</h3>";
                                } else {
                                    //editing components
                    ?>
                        ...
                        <?php
                                    while ($r = mysql_fetch_array($result)) {
                                        ...
                                        . "<td class=\"tddata\"><a title=\"Start Test\" href=\"stdtest.php?id=".$_GET['id'].'&'."stdname=".$_GET['id'].'&'."testcode=" . htmlspecialchars_decode($r['testname'], ENT_QUOTES) . "\"><img src=\"images/starttest.png\" height=\"30\" width=\"40\" alt=\"Start Test\" /></a></td></tr>";
                                    }
                        ?>
                                </table>
                    <?php
