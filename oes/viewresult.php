...
<div class="panel panel-default">
  ...
  <div class="panel panel-default">
  <div class="panel-heading"><h3>Applicant Result</h3></div>
  <div class="panel-body">
            ...
            <form id="summary" action="viewresult.php" method="post">
                    ...
                    <ul id="menu">
                        ...
                        if(isset($_REQUEST['details'])) {
                         ...
                         ?>
                        <li><input type="submit" value="OK" name="logout" class="btn btn-info"title="Log Out"/></li>
                       <li><input type="submit" value="Back" name="back" class="btn btn-info" title="Back"/></li>
                        <?php
                        }
                        else
                        {
                ...
                <div class="page">
                    ...
                    <table cellpadding="20" cellspacing="30" border="0" style="background:#ffffff url(images/page.gif);text-align:left;line-height:20px;">
                        ...
                        <tr>
                            <td colspan="2" ><hr style="border-width:2px;"/></td>
                        </tr>
                         <tr>
                            <td colspan="2"><h3 style="text-align:center;">Test Information in Detail</h3></td>
                        </tr>
                        <tr>
                            <td colspan="2" ><hr style="border-width:4px;"/></td>
                        </tr>
                    </table>
                                <?php
            ...
            while($r=mysql_fetch_array($result)) {
                                        ...
                                        executeQuery("update studenttest set correctlyanswered=".(($om/$tm)*100)." where testid=".$_SESSION['testid']." and stdid=".$_SESSION['stdid'].";");
