				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						//else echo '<form name="frmUser" method="post" action="attendance2.php">';
							...
							$keydate = "WHERE attendance_date BETWEEN '$datef' AND '$datet' AND attendance.employee_id = '".$id."' AND (attendance.status = 'Done' OR attendance.attendance_status = 'active' OR attendance.attendance_status = 'outforbreak' OR attendance.attendance_status = 'infrombreak')";
