					...
					<div class="ibox-content">
						...
						<?php
							include('dbconfig.php');
								...
								if ($result = $mysqli->query("SELECT * FROM coaching INNER JOIN employee ON employee.employee_id = coaching.employee_id WHERE coaching_status = 'Pending'")) //get records from db
								{
									...
									echo "</tfoot>";
										...
										while ($row = mysqli_fetch_object($result))
										{
											...
											echo "<td><a href='#' id='$empid' data-toggle='modal' 
