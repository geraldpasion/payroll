				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<?php
							...
							if ($result = $mysqli->query("SELECT * FROM inquiry RIGHT JOIN employee ON employee.employee_id = inquiry.employee_id WHERE inquiry_status = 'answered' AND (employee_team = '$team1' OR employee_team = '$team2' OR employee_team = '$team3' OR employee_team = '$team4') AND (employee_level = 1 OR employee_level = 2 OR employee_level = 3) ORDER BY inquiry_date DESC")) //get records from db
							{
