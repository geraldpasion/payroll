					...
					<div class="ibox-content">
						...
						<?php
							include('dbconfig.php');
								...
								if ($result = $mysqli->query("SELECT * FROM coaching INNER JOIN employee ON employee.employee_id = coaching.employee_id WHERE coaching_status = 'Completed'")) //get records from db
								{
